        ...
        <div className="container py-5">
          ...
          <div className="text-center bg-primary text-white p-5 rounded shadow mb-5">
            ...
            <div className="d-flex flex-column align-items-center gap-3">
              ...
              <Link to="/courses/1" className="btn btn-light btn-lg w-50">▶️ Watch Sample Course</Link>
          ...
          <div className="container mt-4 mb-5">
            ...
            {!selectedCourseId ? (
              <div className="row">
                {courses.map(course => (
                  <div key={course.id} className="row mb-5 md-5" onClick={() => handleCourseClick(course.id)}>
